...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [Staging].[tmp_ms_xx_AgeBand] ([AgeBand_ID], [BusinessKey], [Code], [LocalName], [Name], [TextDescription], [AgeBandMax_ID], [AgeBandMin_ID], [ProjectBusinessKey])
        SELECT [AgeBand_ID],
               [BusinessKey],
               [Code],
               [LocalName],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [Staging].[tmp_ms_xx_IndicatorValues] ([IndicatorValues_ID], [BusinessKey], [ActualDate], [ActualLabel], [ActualValue], [Notes], [AgeBandBusinessKey], [CommunityTypeBusinessKey], [DataVersionBusinessKey], [DonorBusinessKey], [FrameworkBusinessKey], [GenderBusinessKey], [GroupBusinessKey], [IndicatorBusinessKey], [InstitutionBusinessKey], [LocationBusinessKey], [OrganizationBusinessKey], [ReportingPeriodBusinessKey], [ResultAreaBusinessKey], [StrategicElementBusinessKey])
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [Staging].[tmp_ms_xx_Location] ([Location_ID], [BusinessKey], [AreaKM], [Code], [Density], [LocalName], [Name], [Population], [ParentLocation_ID], [LocationTypeBusinessKey])
        SELECT [Location_ID],
               [BusinessKey],
               [AreaKM],
               [Code],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [Staging].[tmp_ms_xx_MilestoneValues] ([MilestoneValues_ID], [BusinessKey], [ActualDate], [ActualLabel], [ActualValue], [GroupVersion], [Notes], [AgeBandBusinessKey], [CommunityTypeBusinessKey], [DataVersionBusinessKey], [DonorBusinessKey], [FrameworkBusinessKey], [GenderBusinessKey], [GroupBusinessKey], [InstitutionBusinessKey], [LocationBusinessKey], [MilestoneBusinessKey], [OrganizationBusinessKey], [ReportingPeriodBusinessKey], [ResultAreaBusinessKey], [StrategicElementBusinessKey])
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [Staging].[tmp_ms_xx_Organization] ([Organization_ID], [BusinessKey], [Code], [LocalLongName], [LocalShortName], [LongName], [ShortName], [ParentOrganization_ID], [OrganizationTypeBusinessKey])
...
GO
PRINT N'Altering [Staging].[Project]...';


GO
ALTER TABLE [Staging].[Project] ALTER COLUMN [ProjectTypeBusinessKey] NVARCHAR (400) NULL;
