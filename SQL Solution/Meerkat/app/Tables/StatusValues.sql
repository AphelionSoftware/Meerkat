CREATE TABLE [app].[StatusValues]
    (
      ...
      [Active] INT
        ...
        NOT NULL ,
      [sys_CreatedBy] VARCHAR(255)
        CONSTRAINT [DF_StatusValues_sys_CreatedBy] DEFAULT ( USER_NAME() )
        NOT NULL ,
      [sys_CreatedOn] DATETIME
        CONSTRAINT [DF_StatusValues_sys_CreatedOn] DEFAULT ( GETDATE() )
        NOT NULL ,
      [sys_ModifiedBy] VARCHAR(255)
        CONSTRAINT [DF_StatusValues_sys_ModifiedBy] DEFAULT ( USER_NAME() )
        NOT NULL ,
      [sys_ModifiedOn] DATETIME
        CONSTRAINT [DF_StatusValues_sys_ModifiedOn] DEFAULT ( GETDATE() )
        NOT NULL ,
