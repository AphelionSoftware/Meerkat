...
IF EXISTS (select top 1 1 from [app].[Activity])
...
GO
PRINT N'Altering [app].[Outcome]...';


GO
ALTER TABLE [app].[Outcome]
    ADD [OutcomeSiteName] NVARCHAR (50) NULL;
...
SELECT 'Not implemented' as X
GO
PRINT N'Refreshing [app].[DimOutcome]...';


GO
EXECUTE sp_refreshsqlmodule N'[app].[DimOutcome]';


GO
PRINT N'Altering [mm].[ALL_OutcomeMenuCategory]...';
...
ALTER VIEW [mm].[ALL_OutcomeMenuCategory]
AS
/*---Outputs*/ 
...
FROM app.Outcome
GO
PRINT N'Altering [mm].[ALL_OutcomeMenuGroup]...';
...
ALTER VIEW [mm].[ALL_OutcomeMenuGroup]
AS
...
Where IDX.IDX=8)
GO
PRINT N'Altering [mm].[ALL_OutcomeMenuLink]...';
...
ALTER VIEW [mm].[ALL_OutcomeMenuLink]
AS
SELECT     Title = 'Indicator Details', 
...
WHERE da.Active = 1
GO
PRINT N'Altering [mm].[Outcome2MenuLink]...';
...
ALTER VIEW [mm].[Outcome3MenuLink]
AS
SELECT     Substring(Title,1,50) as Title, Link, ID, Parent 
FROM mm.ALL_OutcomeMenuLink
WHERE OutcomeID = 10
GO
PRINT N'Altering [mm].[Outcome4MenuLink]...';
...
ALTER VIEW [mm].[Outcome4MenuLink]
AS
SELECT     Substring(Title,1,50) as Title, Link, ID, Parent 
FROM mm.ALL_OutcomeMenuLink
WHERE OutcomeID = 11
GO
PRINT N'Altering [mm].[Outcome5MenuLink]...';
...
ALTER VIEW [mm].[Outcome5MenuLink]
AS
SELECT     Substring(Title,1,50) as Title, Link, ID, Parent 
FROM mm.ALL_OutcomeMenuLink
WHERE OutcomeID = 12
GO
PRINT N'Altering [mm].[Outcome6MenuLink]...';
...
ALTER VIEW [mm].[Outcome6MenuLink]
AS
SELECT     Substring(Title,1,50) as Title, Link, ID, Parent 
FROM mm.ALL_OutcomeMenuLink
WHERE OutcomeID = 13
GO
PRINT N'Altering [mm].[Outcome7MenuLink]...';
...
ALTER VIEW [mm].[Outcome7MenuLink]
AS
SELECT     Substring(Title,1,50) as Title, Link, ID, Parent 
FROM mm.ALL_OutcomeMenuLink
WHERE OutcomeID = 14
GO
PRINT N'Altering [mm].[Outcome8MenuLink]...';
...
ALTER VIEW [mm].[Outcome8MenuLink]
AS
SELECT     Substring(Title,1,50) as Title, Link, ID, Parent 
FROM mm.ALL_OutcomeMenuLink
WHERE OutcomeID = 15
...
SELECT 'Not implemented' as X
GO
PRINT N'Altering [dbo].[uspIndicatorTimeline]...';
...
ALTER PROC [dbo].[uspIndicatorTimeline]
...
GO
PRINT N'Altering [dbo].[uspIndicatorsList_MDXKey_PublicSite]...';
...
ALTER PROC [dbo].[uspIndicatorsList_MDXKey_PublicSite]
...
GO
PRINT N'Altering [dbo].[uspKeyIndicators]...';
...
ALTER PROC [dbo].[uspKeyIndicators]
--declare
@OutcomeID int
,@KeyIndicator int = 1
,@LocationID int = 1
...
GO
PRINT N'Refreshing [dbo].[rptIndicatorStatus]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[rptIndicatorStatus]';


GO
PRINT N'Refreshing [dbo].[rptIndicatorStatus_test]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[rptIndicatorStatus_test]';


GO
PRINT N'Refreshing [dbo].[uspIndicatorsList_MDXKey_Provincial]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[uspIndicatorsList_MDXKey_Provincial]';
