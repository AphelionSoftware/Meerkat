...
(function (lightSwitchApplication) {
    ...
    msls._addEntryPoints(lightSwitchApplication.OutputOutputLink, {
        /// <field>
        /// Called when a new outputOutputLink is created.
        /// <br/>created(msls.application.OutputOutputLink entity)
        /// </field>
        created: [lightSwitchApplication.OutputOutputLink]
    });
    ...
    msls._addEntryPoints(lightSwitchApplication.SubOutputPersonRole, {
        /// <field>
        /// Called when a new subOutputPersonRole is created.
        /// <br/>created(msls.application.SubOutputPersonRole entity)
        /// </field>
        created: [lightSwitchApplication.SubOutputPersonRole]
    });

    msls._addEntryPoints(lightSwitchApplication.SubOutputSubOutputLink, {
        /// <field>
        /// Called when a new subOutputSubOutputLink is created.
        /// <br/>created(msls.application.SubOutputSubOutputLink entity)
        /// </field>
        created: [lightSwitchApplication.SubOutputSubOutputLink]
    });
    ...
    msls._addEntryPoints(lightSwitchApplication.OrganizationPersonRole, {
        /// <field>
        /// Called when a new organizationPersonRole is created.
        /// <br/>created(msls.application.OrganizationPersonRole entity)
        /// </field>
        created: [lightSwitchApplication.OrganizationPersonRole]
    });
