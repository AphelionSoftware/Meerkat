CREATE TABLE [RBM].[StatusValues] (
    ...
    CONSTRAINT [CK_ENFORCE_SINGLE_Parent_Link_StatusValues] CHECK (((((case when [StatusValues].[ProjectID] IS NOT NULL then (1) else (0) end+case when [StatusValues].[Output_ID] IS NOT NULL then (1) else (0) end)+case when [StatusValues].[OutcomeID] IS NOT NULL then (1) else (0) end)+case when [StatusValues].[Activity_ID] IS NOT NULL then (1) else (0) end)+case when [StatusValues].[SubOutput_ID] IS NOT NULL then (1) else (0) end)=(1)),
