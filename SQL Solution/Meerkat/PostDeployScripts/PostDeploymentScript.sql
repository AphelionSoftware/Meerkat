...
, [OutcomeSiteName])
 ...
 SELECT 1, N'Outcome 1', N'Outcome 1 Long name', N'Outcome 1', N'Shortname', N'Text Description', N'Outcome1'
 WHERE NOT EXISTS
...
, [OutcomeSiteName])
 ...
 SELECT 2, N'Outcome 2', N'Outcome 2 Long name', N'Outcome 2', N'Shortname', N'Text Description', N'Outcome2'
 WHERE NOT EXISTS
...
, [OutcomeSiteName])
 ...
 SELECT 3, N'Outcome 3', N'Outcome 2 Long name', N'Outcome 3', N'Shortname', N'Text Description', N'Outcome3'
 WHERE NOT EXISTS
...
, [OutcomeSiteName])
 ...
 SELECT 4, N'Outcome 2', N'Outcome 4 Long name', N'Outcome 4', N'Shortname', N'Text Description', N'Outcome4'
 WHERE NOT EXISTS
...
, [OutcomeSiteName])
 ...
 SELECT 5, N'Outcome 5', N'Outcome 2 Long name', N'Outcome 5', N'Shortname', N'Text Description', N'Outcome5'
 WHERE NOT EXISTS
...
, [OutcomeSiteName])
 ...
 SELECT 6, N'Outcome 6', N'Outcome 6 Long name', N'Outcome 6', N'Shortname', N'Text Description', N'Outcome6'
 WHERE NOT EXISTS
...
, [OutcomeSiteName])
 ...
 SELECT 7, N'Outcome 2', N'Outcome 7 Long name', N'Outcome 7', N'Shortname', N'Text Description', N'Outcome7'
 WHERE NOT EXISTS
...
, [OutcomeSiteName])
 ...
 SELECT 8, N'Outcome 8', N'Outcome 8 Long name', N'Outcome 8', N'Shortname', N'Text Description', N'Outcome8'
 WHERE NOT EXISTS
