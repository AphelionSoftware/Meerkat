...
#.\03_Meerkat_ImportRootSite.ps1 -name "Meerkat" -sitecoll "http://carer03/sites/nd" -filePath "C:\GitHub\Meerkat\Installation\SP\Export\Meerkat_Root.cmp" -template STS#0 -user "DEV03\SPInstall"
