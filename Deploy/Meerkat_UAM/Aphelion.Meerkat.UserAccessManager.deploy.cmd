...
set _DeploySetParametersFile=%RootPath%Aphelion.Meerkat.UserAccessManager.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Aphelion.Meerkat.UserAccessManager.zip" (
echo "%RootPath%Aphelion.Meerkat.UserAccessManager.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Aphelion.Meerkat.UserAccessManager.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Aphelion.Meerkat.UserAccessManager.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Aphelion.Meerkat.UserAccessManager.deploy-readme.txt" (
...
start notepad "%RootPath%Aphelion.Meerkat.UserAccessManager.deploy-readme.txt"
)
echo =========================================================
goto :eof
