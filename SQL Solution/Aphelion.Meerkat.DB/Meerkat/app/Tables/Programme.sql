CREATE TABLE [app].[Programme] (
    ...
    [Active]            INT            CONSTRAINT [DF__Programme__Activ__7C1A6C5A] DEFAULT ((1)) NOT NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'ExcludeFromStaging', @value = N'true', @level0type = N'SCHEMA', @level0name = N'app', @level1type = N'TABLE', @level1name = N'Programme', @level2type = N'COLUMN', @level2name = N'isSiteCreated';
