CREATE TABLE [Access].[User_Location] (
    ...
    CONSTRAINT [PK_ProjectLocation] PRIMARY KEY CLUSTERED ([User_Location_ID] ASC),
    ...
    CONSTRAINT [FK_User_Location_User] FOREIGN KEY ([User_ID]) REFERENCES [Access].[User] ([UserID])
);
