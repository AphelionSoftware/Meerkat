...
CREATE VIEW [mm].[oldOutcome6MenuLink]
AS
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'mm', @level1type = N'VIEW', @level1name = N'oldOutcome6MenuLink';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'mm', @level1type = N'VIEW', @level1name = N'oldOutcome6MenuLink';
